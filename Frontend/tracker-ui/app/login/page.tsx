      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-20">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8 animate-fade-in-up">
            ...
            <p className="text-gray-400">Sign in to continue tracking your income</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 animate-fade-in-up animation-delay-100">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-transparent text-gray-500">New to IncomeTracker?</span>
              </div>
            </div>
          ...
          {/* Footer text */}
          <p className="text-center text-gray-500 text-sm mt-8 animate-fade-in-up animation-delay-200">
